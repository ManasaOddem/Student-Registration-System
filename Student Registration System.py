from tkinter import* #Librays this all
...
root.geometry("1250x700+80+90")
root.config(bg=background)




#saving std database in xl file.
...
def Save():
    ...
    N1=Name.get()
    C1=Class.get()
    try:        #if not select the gender u will get exception(Error).
        G1=gender
    except:
    ...
    if N1=="" or C1=="Selec Class" or D2=="" or Rel=="" or S1=="" or fathername=="" or mothername=="" or F1=="" or M1=="":messagebox.showerror("error","Few Data is Missing!")
        ...
        registration_no()  #it will recheck regno and reissue new no.



###########Search data of students by using regno######################
def search():

    text=Search.get() #taking input from entry box.

    Clear() # to clear all the data already available in entry box and other
    saveButton.config(state='disable') #after cliking on search ,save button will diasable
...
#by using below statemnt we can print cell wise  regno
...
##    print(x12)
    ...
    img=(Image.open("student images/"+str(x1)+".jpg")) #we done this to take image name same as regno.
    resized_image=img.resize((190,190))
    photo2=ImageTk.PhotoImage((resized_image))
    lb1.config(image=photo2)
    lb1.image=photo2
...
def Update():
    ...
    #sheet.cell(column=1,row=int(reg_number),value=R1) now no one can update regno.
...
#window top frames
Label(root,text="Email: OddemManasa123@gmail.com",width=10,height=3,bg="#f0687c",anchor='se').pack(side=TOP,fill=X)
Label(root,text="STUDENT REGISTRATION",width=10,height=2,bg="#c36464",fg='#fff',font='arial 20 bold').pack(side=TOP,fill=X)
    
#search box to update
Search=StringVar()
Entry(root,textvariable=Search,width=15,bd=2,font="arial 20").place(x=820,y=70)
imageicon3=PhotoImage(file="images/Serch1.png")
Srch=Button(root,text="Search",compound=LEFT,image=imageicon3,height=35,width=122,bg='White',font="arial 13 bold",command=search)
Srch.place(x=1060,y=66)



imageicon4=PhotoImage(file="images/Layer1.png")
...
registration_no() #called frome here.
...
#Student Details
obj=LabelFrame(root,text="Student's Details",font=20,bd=2,width=900,bg=framebg,fg=framefg,height=210,relief=GROOVE)
...
#Parents Deatils
obj2=LabelFrame(root,text="Parent's Details",font=20,bd=2,width=900,bg=framebg,fg=framefg,height=180,relief=GROOVE)
...
#image
f=Frame(root,bd=3,bg="black",width=200,height=190,relief=GROOVE)
...
Button(root,text="Reset",width=19,height=2,font="arial 12 bold",bg="lightpink",command=Clear).place(x=1000,y=520)
Button(root,text="Exit",width=19,height=2,font="arial 12 bold",bg="grey",command=Exit).place(x=1000,y=590)
